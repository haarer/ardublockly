...
Blockly.Msg.ARD_WS2812_BLUE_VALUE = "blue value:";  // untranslated
Blockly.Msg.ARD_WS2812_COLOR_TIP = "Control WS2812 Led strip";  // untranslated
Blockly.Msg.ARD_WS2812_CONFIG = "Setup WS2812 RGB LED";  // untranslated
Blockly.Msg.ARD_WS2812_CONFIG_TIP = "Set up specified WS2812 Led Strip. Configure Data Pin, Number of LEDS. RGB Mode and frequency are fixed.";  // untranslated
Blockly.Msg.ARD_WS2812_DEFAULT_NAME = "WS2812";  // untranslated
Blockly.Msg.ARD_WS2812_GREEN_VALUE = "green value:";  // untranslated
Blockly.Msg.ARD_WS2812_LED_NO = "LED No:";  // untranslated
Blockly.Msg.ARD_WS2812_LEDs = "No. of LEDs";  // untranslated
Blockly.Msg.ARD_WS2812_PIN = "Pin";  // untranslated
Blockly.Msg.ARD_WS2812_RED_VALUE = "red value:";  // untranslated
Blockly.Msg.ARD_WS2812_SET_RGB_LED = "Set RGB LED";  // untranslated
Blockly.Msg.ARD_WS2812_SHOW = "Show LED output";  // untranslated
Blockly.Msg.ARD_WS2812_SHOW_TIP = "Show all previously configured LED values on LED strip";  // untranslated
Blockly.Msg.ARD_WS2812_TIP = "WS2812 Led Strip Instance";  // untranslated

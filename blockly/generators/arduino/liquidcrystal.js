...
Blockly.Arduino['liquidcrystal_i2cconfig'] = function(block) {
  ...
  Blockly.Arduino.addInclude('rgblcd', '#include <Adafruit_RGBLCDShield.h>');
  Blockly.Arduino.addInclude('mcp23017', '#include <utility/Adafruit_MCP23017.h>');

  var globalCode = 'Adafruit_RGBLCDShield ' + lcdName + ' = Adafruit_RGBLCDShield();';
  Blockly.Arduino.addDeclaration(lcdName, globalCode);

...
// Ardublockly strings
Blockly.Msg.ARD_ANALOGREAD = "lese Analogpin#";
Blockly.Msg.ARD_ANALOGREAD_TIP = "Rückgabewert zwischen 0 und 1024";
Blockly.Msg.ARD_ANALOGWRITE = "setze Analogpin#";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "Schreibe analog Wert zwischen 0 und 255 auf bestimmten PWM Port";
Blockly.Msg.ARD_BUILTIN_LED = "Setze eingebaute LED";
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Arduino LED an- oder ausschalten";
Blockly.Msg.ARD_COMPONENT_WARN1 = "Ein %1 Konfigurationsblock mit dem selben %2 Namen wird benötigt um diesen Block zu verwenden!";
Blockly.Msg.ARD_DEFINE = "Definiere";
Blockly.Msg.ARD_DIGITALREAD = "Lese Digitalpin#";
Blockly.Msg.ARD_DIGITALREAD_TIP = "Lese Digitalwert von Pin: HIGH oder LOW";
Blockly.Msg.ARD_DIGITALWRITE = "Setze Digitialpin#";
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Setze Digitalwert HIGH oder LOW an bestimmten Pin";
Blockly.Msg.ARD_FUN_RUN_LOOP = "Arduino Hauptschleife:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "Arduino Initialisierung:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Definiert die Arduino setup() and loop() Funktionen.";
Blockly.Msg.ARD_HIGH = "HIGH";
Blockly.Msg.ARD_HIGHLOW_TIP = "Setze einen Pin auf High oder Low.";
Blockly.Msg.ARD_LOW = "LOW";
Blockly.Msg.ARD_MAP = "Zuordnen";
Blockly.Msg.ARD_MAP_TIP = "Ordnet eine Zahl [0-1024] einer anderen zu.";
Blockly.Msg.ARD_MAP_VAL = "Wert zu [0-";
Blockly.Msg.ARD_NOTONE = "Ton abschalten an Pin #";
Blockly.Msg.ARD_NOTONE_PIN = "Ton aus PIN#";
Blockly.Msg.ARD_NOTONE_PIN_TIP = "Schalte Ton an Pin aus";
Blockly.Msg.ARD_NOTONE_TIP = "Schaltet den Ton am gewählten Pin ab.";
Blockly.Msg.ARD_PIN_WARN1 = "Pin %1 wird für %2 als Pin %3 benötige, ist aber schon als %4 verwendet.";
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "Misst die Impulsbreite am gewählten Pin, wenn sie kleiner als das Timeout ist.";
Blockly.Msg.ARD_PULSE_READ = "messe %1 Pulslänge an Pin #%2";
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "messe %1 Pulslänge an Pin #%2 (Timeout nach %3 μs)";
Blockly.Msg.ARD_PULSE_TIP = "Messen der Impuldauer am gewählten Pin.";
Blockly.Msg.ARD_SERIAL_BPS = "bps";
Blockly.Msg.ARD_SERIAL_PRINT = "Gebe Aus";
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "Neue Zeile";
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "Gibt daten auf die Konsole / serielle Schnittstelle als Text aus.";
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "Setup Block wird für %1 benötigt!";
Blockly.Msg.ARD_SERIAL_SETUP = "Einstellung";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Bestimmt die Bitrate für eine serielle Schnittstelle";
Blockly.Msg.ARD_SERIAL_SPEED = ":  Bitrate";
Blockly.Msg.ARD_SERVO_READ = "lese SERVO von PIN#";
Blockly.Msg.ARD_SERVO_READ_TIP = "Lese Servo Winkel";
Blockly.Msg.ARD_SERVO_WRITE = "setze SERVO von Pin";
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "Grad (0~180)";
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Setze Servo auf angegebenen Winkel";
Blockly.Msg.ARD_SERVO_WRITE_TO = "auf";
Blockly.Msg.ARD_SETTONE = "Tonausgabe an Pin #";
Blockly.Msg.ARD_SPI_SETUP = "Einstellungen";
Blockly.Msg.ARD_SPI_SETUP_CONF = "Konfiguration:";
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "Takt Teiler";
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSB Zuerst^";
...
Blockly.Msg.ARD_SPI_SETUP_MSBFIRST = "MSB Zuerst";
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "Schieberichtung";
Blockly.Msg.ARD_SPI_SETUP_TIP = "Einstellungen für SPI.";
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "Sende SPI Nachricht zum angegebenen Empfänger um Daten zu erhalten.";
Blockly.Msg.ARD_SPI_TRANS_NONE = "none";
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "CS Pin:";
Blockly.Msg.ARD_SPI_TRANS_TIP = "Sende SPI Nachricht zum durch den angegebenen CS Pin aktivierten Empfänger";
Blockly.Msg.ARD_SPI_TRANS_VAL = "sende";
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "Ein Konfigurationsblock für %1 wird benötigt um diesen Block zu verwenden!";
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "Alter Pin wert %1 ist nicht mehr verfügbar.";
Blockly.Msg.ARD_STEPPER_COMPONENT = "Schrittmotor";
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "MeinMotor";
...
Blockly.Msg.ARD_STEPPER_REVOLVS = "Anzahl Schritte pro Umdrehung";
Blockly.Msg.ARD_STEPPER_SETUP = "Schrittmotor einstellen";
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Einstellung den Motor Pinbelegung und weitere Einstellungen.";
Blockly.Msg.ARD_STEPPER_SPEED = "setze Drehzahl (U/min) auf";
Blockly.Msg.ARD_STEPPER_STEP = "bewege Schrittmotor";
Blockly.Msg.ARD_STEPPER_STEPS = "Schritte";
Blockly.Msg.ARD_STEPPER_STEP_TIP = "Dreht die Achse des Schrittmotors um eine bestimmte Anzahl Schritte.";
Blockly.Msg.ARD_STEPPER_TWO_PINS = "2";
Blockly.Msg.ARD_TIME_DELAY = "Warten";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "Mikrosekunden";
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Warte angegebene Zeit in Mikrosekunden";
Blockly.Msg.ARD_TIME_DELAY_TIP = "Warte angegebene Zeit in Millisekunden";
Blockly.Msg.ARD_TIME_INF = "Warte endlos (Programm anhalten)";
Blockly.Msg.ARD_TIME_INF_TIP = "Warte für immer, hält das Programm an.";
Blockly.Msg.ARD_TIME_MICROS = "Vergangene Zeit (Mikrosekunden)";
Blockly.Msg.ARD_TIME_MICROS_TIP = "Gibt die Zeit in Mikrosekunden seit dem Start des Arduino zurück. Muß als positiver long Integer gespeichert werden";
Blockly.Msg.ARD_TIME_MILLIS = "Vergangene Zeit (Millisekunden)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Gibt die Zeit in Millisekunden seit dem Start des Arduino zurück. Muß als positiver long Integer gespeichert werden";
...
Blockly.Msg.ARD_TONE_PIN_TIP = "Erzeuge Ton an Pin";
Blockly.Msg.ARD_TONE_TIP = "Erzeugt Ton am Pin mit der eingestellten Frequenz 31 - 65535";
Blockly.Msg.ARD_TONE_WARNING = "Frequenz muss im Bereich 31 - 65535 sein";
Blockly.Msg.ARD_TYPE_ARRAY = "Array";
Blockly.Msg.ARD_TYPE_BOOL = "Boolean";
Blockly.Msg.ARD_TYPE_CHAR = "Zeichen";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "Kind Block fehlt";
Blockly.Msg.ARD_TYPE_DECIMAL = "Decimal";
Blockly.Msg.ARD_TYPE_LONG = "Große Zahl (Long)";
Blockly.Msg.ARD_TYPE_NULL = "Null";
Blockly.Msg.ARD_TYPE_NUMBER = "Zahl";
Blockly.Msg.ARD_TYPE_SHORT = "Kleine Zahl(Short)";
Blockly.Msg.ARD_TYPE_TEXT = "Text";
Blockly.Msg.ARD_TYPE_UNDEF = "Undefiniert";
Blockly.Msg.ARD_VAR_AS = "als";
Blockly.Msg.ARD_VAR_AS_TIP = "Wandelt Wert in einen bestimmten Typ";
Blockly.Msg.ARD_WRITE_TO = "auf";
Blockly.Msg.ARD_WS2812_BLUE_VALUE = "Blauanteil:";
Blockly.Msg.ARD_WS2812_COLOR_TIP = "Ansteuerung WS2812 LED Streifen";
Blockly.Msg.ARD_WS2812_CONFIG = "Einstellungen WS2812 RGB LED";
Blockly.Msg.ARD_WS2812_CONFIG_TIP = "Einstellung für angegebenen LED Streifen.";
Blockly.Msg.ARD_WS2812_DEFAULT_NAME = "WS2812";
Blockly.Msg.ARD_WS2812_GREEN_VALUE = "Grünanteil:";
Blockly.Msg.ARD_WS2812_LED_NO = "LED Nr.:";
Blockly.Msg.ARD_WS2812_LEDs = "Anzahl der LEDs";
Blockly.Msg.ARD_WS2812_PIN = "Pin";
Blockly.Msg.ARD_WS2812_RED_VALUE = "Rotanteil:";
Blockly.Msg.ARD_WS2812_SET_RGB_LED = "Setze RGB LED";
Blockly.Msg.ARD_WS2812_SHOW = "Anzeigen";
Blockly.Msg.ARD_WS2812_SHOW_TIP = "zeige alle eingestellten LED Werte an.";
Blockly.Msg.ARD_WS2812_TIP = "WS2812 Led Streifen";
Blockly.Msg.ARD_WS2812_TO_COLOR = "auf Farbe:";
Blockly.Msg.NEW_INSTANCE = "Neue Instanz...";
Blockly.Msg.NEW_INSTANCE_TITLE = "Name der neuen Instanz:";
Blockly.Msg.RENAME_INSTANCE = "Instanz umbenennen...";
Blockly.Msg.RENAME_INSTANCE_TITLE = "Alle '%1' Instanzen umbenennen:";

...
Blockly.Msg.ARD_LIQUIDCRYSTAL_I2CCONFIG = 'Setup i2c LCD';
...
Blockly.Msg.ARD_BLYNK_CONNECT = 'Connect to network:';
Blockly.Msg.ARD_BLYNK_PWD = ', password:';
Blockly.Msg.ARD_BLYNK_AUTH_CODE = 'Blynk Auth Code:';
Blockly.Msg.ARD_BLYNK_ON = 'on';
Blockly.Msg.ARD_BLYNK_SET_LED_WIDGET = 'Set LED widget';
Blockly.Msg.ARD_BLYNK_LED_DEFAULT_NAME = 'LED';
Blockly.Msg.ARD_BLYNK_SET_LED = 'Set LED';
Blockly.Msg.ARD_BLYNK_BLYNK_WRITE = 'on Blynk write';
Blockly.Msg.ARD_BLYNK_READ_PARAMETER = 'read parameter as';